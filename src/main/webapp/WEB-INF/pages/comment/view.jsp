        ...
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach items="${comments}" var="comment">
                <tr>
                    ...
                    <td>${comment.time}</td>
                    <td>
                        <a href="<c:url value="/actions//article/readArticle/${comment.articleId}"/> "><img
                                src="<c:url value="/img/read.png"/>" alt="查看" title="查看"/></a>
                        <a href="javascript:void(0)" onclick="removeComment(${comment.id})"><img
