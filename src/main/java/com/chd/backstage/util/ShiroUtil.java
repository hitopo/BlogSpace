...
public class ShiroUtil {
    ...
    private static final ShiroUtil PASSWORD_UTIL = new ShiroUtil();
     ...
     * @return 相关的加密信息
     */
    public Map<String, Object> EncPassword(Account account) {
        ...
        LOGGER.info("ShiroUtil:加密后密码:{}", encodedPassword);
        LOGGER.info("ShiroUtil:加密的密盐:{}", salt);
    ...
    public boolean isAuthencated(String username, String password) {
        LOGGER.info("Authencated username&password by Shiro table user , username = {}", username);
